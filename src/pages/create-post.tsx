...
//   const handleUploadComplete = (res: { fileKey?: string; key?: string; id?: string }[]) => {
//     console.log("Upload complete callback triggered.");
//     console.log("Upload response:", res);
...
//         }
//       } else {
//         console.error("Uploaded file is undefined.");
//       }
//     } else {
//       console.error("File upload failed or no files returned.");
//     }
...
//       // Prepare data to send to savePost endpoint
//       const postData: { title: string; content: string; fileKey: string } = {
//         title,
//         content,
//         fileKey,
//       };
